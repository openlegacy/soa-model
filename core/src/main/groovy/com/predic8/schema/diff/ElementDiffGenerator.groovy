...
class ElementDiffGenerator extends UnitDiffGenerator {
  ...
  def removed = {
    new Difference(description: "${labelElementRemoved}.", type: 'element', breaks: ctx.exchange ? true : null, exchange: a.exchange)
  }

  def added = {
    new Difference(description: "${labelElementAdded}.", type: 'element', breaks: ctx.exchange ? true : null, exchange: b.exchange)
  }
